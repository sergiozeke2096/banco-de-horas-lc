...
async function startWhatsAppBot(deps) {
  // Require aqui dentro (nao no topo do arquivo) pra o pacote so precisar
  // estar instalado/carregado quando WHATSAPP_ENABLED=true de verdade tenta
  // ligar o bot.
  ...
  async function connect() {
    ...
    sock.ev.on("connection.update", (update) => {
      if (update.qr) {
        console.log("[whatsapp-bot] Escaneie o QR code impresso acima com o WhatsApp que vai atender os funcionarios.");
      }
